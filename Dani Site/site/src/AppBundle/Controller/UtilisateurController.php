...
class UtilisateurController extends Controller
{
  ...
  /**
  * @Route("/back/utilisateur/nouveau", name="utilisateur_nouveau")
  */
    ...
    /**
    * @Route("/back/utilisateur/mod/{id}", name="utilisateur_modif", requirements={"id": "\d+"})
    */
  ...
  /**
  * @Route("/back/utilisateur/supp/{id}", name="utilisateur_suppr", requirements = {"id": "\d+"})
  */
    ...
    /**
    * @Route("/back/utilisateur/active/{id}", name="utilisateur_active", requirements = {"id": "\d+"})
    */
    ...
    /**
     * @Route("/back/utilisateur/{id}", name="utilisateur_id", requirements={"id": "\d+"})
     */
    ...
    /**
     * @Route("/back/utilisateur/", name="utilisateur_liste")
     */
